...
def check_invariants(policy, errors):
    ...
    rules = [
        ...
        ("retry.backend_circuit.transport_signal", "transport_unavailable"),
        ("retry.backend_circuit.failure_window_secs", 180),
        ("retry.backend_circuit.distinct_slots", 2),
        ("retry.backend_circuit.cooldown_secs", 300),
        ...
        ("retry.rate_limited.recovery_probe_required", True),
        ("retry.rate_limited.probe_timeout_secs", 30),
        ("retry.rate_limited.probe_submits_prompt", False),
